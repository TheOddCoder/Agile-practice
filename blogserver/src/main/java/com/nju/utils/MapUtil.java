...
public class MapUtil {
    ...
    public static <K, V> Map<K, V> createMap(Class<?> mapType) {
        return (Map)(mapType.isAssignableFrom(AbstractMap.class) ? new HashMap() : (Map)ReflectUtil.newInstance(mapType, new Object[0]));
    }
    ...
    public static HashMap<Object, Object> of(Object[] array) {
        if (array == null) {
            ...
            HashMap<Object, Object> map = new HashMap((int)((double)array.length * 1.5D));
        ...
        if (CollUtil.isEmpty(mapList)) {
            ...
            while(var3.hasNext()) {
                ...
                while(var7.hasNext()) {
                    ...
                    if (null == valueList) {
                        valueList = (List<V>) CollUtil.newArrayList(new Object[]{entry.getValue()});
    ...
    public static <T> T get(Map<?, ?> map, Object key, Class<T> type) {
        return (T) get(map, key, (Class)type, (Object)null);
    }
    ...
    public static <T> T get(Map<?, ?> map, Object key, TypeReference<T> type) {
        return (T) get(map, key, (TypeReference)type, (Object)null);
    }
